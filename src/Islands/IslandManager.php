...
class IslandManager
{
    ...
    /**
     * Nested islands count their occurrences within the containing island.
     */
    ...
    /**
     * Moves the "with" snapshots captured while mounting onto the memoized
     * island entries; entries that already carry one stay frozen at mount.
     */
     ...
     * compiler never mangles the Antlers syntax.
     */
